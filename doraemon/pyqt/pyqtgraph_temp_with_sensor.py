...
class window(QWidget):
    def __init__(self):
        ...
        self.temp_title.setText('檢測溫度 : ')
        self.temp_title.setFrameShape(QFrame.Box)
        self.temp_title.setFrameShadow(QFrame.Raised)
        self.temp_title.setStyleSheet('border-width: 2px; border-style: solid; border-color:rgb(0, 0, 0)')
        ...
        self.unit.setText('°C')
        self.unit.setGeometry(780,120,200,200) # (水平, 垂直, 寬度, 高度)

        # Temperature
        self.temp_show = QLabel(self)
        self.temp_show.setText('0.00')
        self.temp_show.setGeometry(350,120,450,200) # (水平, 垂直, 寬度, 高度)

        # Title with number of people measured box
        self.title_with_number_of_people_measured = QLabel(self)
        self.title_with_number_of_people_measured.setText('測溫人數 : ')
        ...
        self.title_with_number_of_people_measured.setStyleSheet('border-width: 2px; border-style: solid; border-color:rgb(0, 0, 0)')
        ...
        self.number_of_people_measured.setText('0')
        self.number_of_people_measured.setGeometry(30,10,200,200) 

        # Title with number of alarm box
        self.title_with_number_of_alarm = QLabel(self)
        self.title_with_number_of_alarm.setText('報警次數 : ')
        self.title_with_number_of_alarm.setFrameShape(QFrame.Box)
        self.title_with_number_of_alarm.setFrameShadow(QFrame.Raised)
        self.title_with_number_of_alarm.setStyleSheet('border-width: 2px; border-style: solid; border-color:rgb(0, 0, 0)')
        ...
        self.number_of_alarm.setText('0')
        self.number_of_alarm.setGeometry(30,180,200,200) 
        ...
        self.scan.setStyleSheet('border-width: 2px; border-style: solid; border-color:rgb(0, 0, 0)')
        ...
        self.announcement.setText('請保持 1 米距離, 戴口罩, 勤洗手!!')
        self.announcement.setFrameShape(QFrame.Box)
        self.announcement.setFrameShadow(QFrame.Raised)
        self.announcement.setStyleSheet('border-width: 2px; border-style: solid; border-color:rgb(0, 0, 0)')
